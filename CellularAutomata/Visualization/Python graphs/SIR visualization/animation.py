...
# opens csv file
file = "E:\python charts\Visualization\Python graphs\SIR visualization\dataoutputanimation.csv"
...
for idx, file in enumerate(file_list):
    ...
    SIR_frames.append(iteration)
                        ...
                        # Color Sequence -  Empty, Infected, Dead, Buried, Susceptible, Recovered
my_cmap = matplotlib.colors.ListedColormap(["Blue", "Green", "Yellow", "Orange", "Red", "Purple"])

# animate function
def animate(i):
    ax.clear()
    print("Iteration = "+str(i)+"  \r")#, end='\r')
    ax.contourf(SIR_frames[i], 100, cmap=my_cmap, vmin=0, vmax=5)
    return fig,
